...
export const metadata: Metadata = {
  title: 'Micoh Angelo Ojeñar — Full-Stack Developer',
  description: 'Portfolio of Micoh Angelo Ojeñar, a full-stack developer building modern web and mobile applications.',
  generator: 'v0.app',
}
