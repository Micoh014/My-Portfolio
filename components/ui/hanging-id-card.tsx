          ...
          {children ?? (
            <div className="flex flex-col h-full">
              ...
              >
                ...
                {/* User Profile Avatar */}
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white/20 backdrop-blur-md mt-1 border-2 border-white/40 shadow-md overflow-hidden">
                  {avatarUrl ? (
