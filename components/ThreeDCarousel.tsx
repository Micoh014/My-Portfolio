              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {/* Image Header */}
                    <div
                      className="relative bg-slate-900 p-5 flex items-start justify-between h-40 overflow-hidden shrink-0"
                      style={{
                    ...
                    >
                      ...
                      <ArrowUpRight className="relative z-10 text-white/80 w-5 h-5" />
                    ...
                    {/* Card Content Body */}
                    <CardContent className="p-5 flex flex-col flex-grow justify-between bg-paper overflow-y-auto">
                      <div>
                          ...
                          <div className="case-study my-2 py-2 border-y border-border flex flex-col gap-2 text-xs">
                            ...
                            {item.caseStudy && (
                              <details className="mt-1 text-xs">
                                <summary className="cursor-pointer font-semibold text-foreground hover:underline transition-colors">
                                  Read case study
                                </summary>
                                <p className="mt-2 text-muted-foreground leading-relaxed text-[11px] bg-background/60 p-2.5 rounded border border-border">
                                  {item.caseStudy}
                                </p>
                              </details>
                            )}
                        ...
                        {/* Full Modal Expandable Card Trigger */}
                        {item.caseStudy && (
                          <div className="my-2">
                            <ExpandableCard
                              title={item.title}
